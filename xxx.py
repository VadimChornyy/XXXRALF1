...
adat0=''
def RALF1Calculation(ar0,arr_z,Lengt,Nf,NNew,nn,aTmStop,gray_sz1,gray_sz2):           
    #key=13                                 
...
if __name__ == '__main__': 
    for uuii in range(Nii):
        ...
        dd=RALF1Calculation(ar0,arr_z,Lengt,Nf,NNew,nn,aTmStop,gray_sz1,gray_sz2)     
